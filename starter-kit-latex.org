...
#+begin_src emacs-lisp :tangle yes
(use-package bibtex
  :bind ("s-\]" . crossref-add-bibtex-entry)
  :custom
...
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24496 493 619340 893000) :init (24496 493 619177 249000) :config (24496 493 619139 812000) :config-secs (0 0 893 152000) :init-secs (0 0 965 955000) :use-package-secs (0 0 1938 606000)))
