...
(use-package moody
 ...
 (defun set-moody-face (frame)
       (let ((line (face-attribute 'mode-line :underline)))
         ...
         (set-face-attribute 'mode-line          nil :overline   "#d33682") ; line
         (set-face-attribute 'mode-line-inactive nil :underline  line)
         ;(set-face-attribute 'mode-line         nil :box        nil)
         (set-face-attribute 'mode-line-inactive nil :box        nil)
         (set-face-attribute 'mode-line          nil :box "#d33682")))
...
#+RESULTS:
| exwm-workspace--on-after-make-frame | exwm-manage--add-frame | x-dnd-init-frame | set-moody-face | aw--after-make-frame |
