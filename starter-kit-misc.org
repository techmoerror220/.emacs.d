...
(defun set-moody-face (frame)
    (let ((line (face-attribute 'mode-line :underline frame)))
      ...
      (set-face-attribute 'mode-line-inactive frame :overline   line)
      (set-face-attribute 'mode-line-inactive frame :underline  line)
      (set-face-attribute 'mode-line          frame :box        nil)  ; nil
      (set-face-attribute 'mode-line-inactive frame :box        nil)))
...
(use-package moody
 ...
 (defun set-moody-face (frame)
       (let ((line (face-attribute 'mode-line :underline)))
         ...
         (set-face-attribute 'mode-line          nil :overline   line) ; line
...
Alternative by https://github.com/gonsie/dotfiles/blob/master/emacs/theme.el#L75
Also: https://dev.to/gonsie/beautifying-the-mode-line-3k10
...
#+RESULTS:
: [nil 24101 34486 680014 3600 theme-switcher nil nil 84000]
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24101 34498 201301 682000) :init (24101 34498 201288 54000) :config (24101 34498 201128 203000) :config-secs (0 0 3 586000) :init-secs (0 0 314 333000) :use-package-secs (0 0 350 514000)))
