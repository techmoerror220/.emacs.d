...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24229 24847 106015 760000) :init (24229 24847 105986 117000) :config (24229 24847 105761 37000) :config-secs (0 1 625202 558000) :init-secs (0 1 625918 36000) :use-package-secs (0 1 626144 950000)))
...
*** My =get-spaceline-working= function
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24222 42903 935690 928000) :init (24222 42903 935661 793000) :config (24222 42903 935104 956000) :config-secs (0 0 12 934000) :init-secs (0 0 938 344000) :use-package-secs (0 0 1094 360000)))
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24229 14523 970736 698000) :init (24229 14523 970729 512000) :config (24229 14523 970606 58000) :config-secs (0 0 948408 908000) :init-secs (0 0 948686 318000) :use-package-secs (0 0 948795 165000)))
