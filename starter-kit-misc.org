...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24654 13256 567196 767000) :init (24654 13256 567165 660000) :config (24654 13256 566642 186000) :config-secs (0 0 11 411000) :init-secs (0 0 1826 802000) :use-package-secs (0 0 2656 87000)))
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24622 55011 221887 522000) :init (24622 55011 221872 32000) :config (24622 55011 221579 155000) :config-secs (0 0 8 784000) :init-secs (0 0 624 511000) :use-package-secs (0 2 583979 547000)))
