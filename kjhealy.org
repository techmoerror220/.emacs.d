...
The Starter Kit uses Ethan Schoonover's /Solarized/ color theme. Load it with =M-x load-theme solarized-dark= or =M-x load-theme solarized-light=. You can also try loading the =zenburn-theme= or =tango-2= themes. 
