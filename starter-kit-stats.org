...
** Markdown-mode
Read https://github.com/jrblevin/markdown-mode (with a book)

Recall =markdown= is an external package to install via =apt=, =rmarkdown= is an R library to install via =install.packages("")= (with a book). 
...
- Read: https://polymode.github.io/ and https://masteringemacs.org/article/polymode-multiple-major-modes-how-to-use-sql-python-in-one-buffer
...
The settings for python and sql from Mickey Peterson at https://masteringemacs.org/article/polymode-multiple-major-modes-how-to-use-sql-python-in-one-buffer
#+source: Polymode
#+begin_src emacs-lisp
...
#+RESULTS: Polymode
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24155 60187 842493 445000) :init (24155 60187 842480 711000) :init-secs (0 0 57312 784000) :use-package-secs (0 0 57373 384000) :config (24155 60187 842346 460000) :config-secs (0 0 3 254000)))


#+source: Poly-R and Markdown
#+begin_src emacs-lisp
  (use-package poly-R
    :ensure t
    :pin melpa-stable)
