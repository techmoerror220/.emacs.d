...
;; From uncle dave's dot files; DGM turns it off to try and speed up editing (I can see it in an .R file)
...
#+RESULTS: starter-kit-recentf-ido-find-file
: recentf-ido-find-file

** Lore Ipsum
From: https://www.emacswiki.org/emacs/LoremIpsum
...
*** COMMENT Originally I had only one paragraph

Useful when a large block of text is required (e.g. for testing)
#+srcname: starter-kit-lorem-simple
#+begin_src emacs-lisp 
