...
**** Patches to =biblatex=
:PROPERTIES:
:ID:       9fd330d6-2f78-4e76-88db-29a2f32573ca
:END:
...
* Setup
NB: DGM notes that the =Setup= section originally had a =:noexport:= tag and I guess that is why I had issues with =jk-...=.
...
*** PDF process
:PROPERTIES:
:ID:       4877cfc1-64fe-4d55-9cfd-9c913570c7f3
:END:

NB: DGM adds =-shell-escape= on 6 Dic 2019 and on the 8th I disabled it in favor of what I have in the =starter-kit-latex-org.org= file ([[id:e9f6cdbc-2253-4c86-a7b2-d77ded4807e9][XeLaTeX and pdfLaTeX Org Export Settings]])
...
DGM comments this out on 3rd january 2020 cos I think this is screwing my change to latex from xelatex.
#+name: pdf-process-bibtex
#+header: :results silent
#+begin_src emacs-lisp
 (setq org-latex-pdf-process
...
NB: DGM adds =#+LATEX_HEADER: \usepackage{amssymb}= on 6 Dic 2019 and ==\RequirePackage{etex}== instead of ==\usepackage{etex}==
...
#+BEGIN_SRC emacs-lisp 
(provide 'starter-kit-tufte-latex.org)
#+END_SRC

#+RESULTS:
: starter-kit-tufte-latex\.org
...
#+source: message-line
#+begin_src emacs-lisp
(message "Starter Kit Tufte Latex File loaded.")
#+end_src

#+RESULTS: message-line
: Starter Kit Tufte Latex File loaded.
