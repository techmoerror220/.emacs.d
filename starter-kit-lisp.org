...
** COMMENT Non-obtrusive parenthesis faces

I can't recall why this is commented out... previously I had used the option =:tangle no= and so I had disabled all the other snippets of code.
