...
;; mu4e-compose-mode taken out of the list or else I don't get to complete email addresses.b
(setq company-global-modes '(not python-mode org-mode text-mode latex-mode tex-mode LaTeX-mode TeX-mode))
#+end_src
