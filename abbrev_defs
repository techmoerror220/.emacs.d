...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("differente" "different" nil :count 1)
    ...
    ("k" "the" nil :count 20)
    ("ldtos" "ldots" nil :count 2)
    ("levls" "levels" nil :count 1)
    ("lk" "like" nil :count 2)
    ("lso" "los" nil :count 4)
    ("lt" "\\hologo{LaTeX}" nil :count 10)
    ...
    ("situaion" "situation" nil :count 1)
