...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("conditioon" "condition" nil :count 2)
    ...
    ("preugntas" "preguntas" nil :count 1)
    ...
    ("tb" "también" nil :count 4)
    ("td" "today" nil :count 2)
    ("teh" "the" nil :count 37)
