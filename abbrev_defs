...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("directametne" "directamente." nil :count 2)
    ...
    ("qeu" "que" nil :count 18)
    ("qt" "¿qué tal?" nil :count 2)
    ("realmnete" "realmente" nil :count 2)
    ...
    ("usal" "Un saludo, Daniel " nil :count 1)
