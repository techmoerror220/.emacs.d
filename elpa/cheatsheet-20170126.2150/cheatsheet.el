...
;; no se' como cambiarlo a bold. con o sin ' no funciona
(defface cheatsheet-group-face
  '((t :foreground "#268bd2")
    (t :weight 'ultra-bold))  ;; originally red and not bold (i.e., normal weight)
  "Group name font face.")

(defface cheatsheet-key-face
  '((t :foreground "#2aa198"))   ;; originally orange
  "Cheat key font face.")
