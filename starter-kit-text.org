...
** Smart Parentheses
Smart parentheses using [[https://github.com/Fuco1/smartparens][smartparens]] minor mode. Smartparens provides a lot of nice functionality around balanced pairs of parentheses or other delimiters. More information is available from [[https://github.com/Fuco1/smartparens/wiki#wiki-what-is-this-package-about?][its Wiki]].
#+srcname: starter-kit-match-parens
#+begin_src emacs-lisp 
  (smartparens-global-mode 1)
  (require 'smartparens-config)
  (setq sp-highlight-pair-overlay nil) ;; Don't highlight inside every paren.
...
#+end_src
** Polymode (Experimental) 
Polymode is an emacs package that offers support for multiple major modes inside a single emacs buffer. The idea is to be able to easily combine, e.g., R and Markdown in an .Rmd file---much like Snw or Rnw files, but in a more generic and generalizable way. Right now we just use it for .Rmd files.

#+source: load-polymode
#+begin_src emacs-lisp
  (require 'poly-R)
