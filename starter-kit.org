...
#+RESULTS: starter-kit-load-elisp-dir
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-defuns.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-latex.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-bindings.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-misc.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-completion.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-eshell.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-lisp.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-js.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-perl.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-python.el
...
*** Starter Kit Parens
Located in [[file:starter-kit-text.org][starter-kit-parens]]
...
Disabled in Ubuntu as I get this error: 

#+begin_example sh

Error (use-package): mu4e/:catch: Wrong number of arguments: (3 . 4), 2 Disable showing Disable logging

#+end_example

It seems the problem is general (January 2021):

#+BEGIN_QUOTE

A recent update on Emacs HEAD changed the define-obsolete-function-alias macro, which broke the plugins that use it.

Until packages have caught up, I recommend you avoid updating Emacs or revert to Emacs 27.1. This only applies to users on Emacs 28.x -- this includes the native-comp branch (gccemacs).

For gccemacs users, the last known good commit is emacs-mirror/emacs@213b5d7

#+END_QUOTE


Disabled until I get mu4e right
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/starter-kit-programming.el
...
#+RESULTS:
: Loaded /home/dgm/.emacs.d/stater-kit-markdown.el
