...
Libraries from [[http://elpa.gnu.org/packages/][ELPA]] or the [[http://marmalade-repo.org/][Marmalade Repo]] are preferred when available since dependencies
